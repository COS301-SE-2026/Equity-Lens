...
@router.get(
    ...
    description="Fetch current price, volume, and percentage change for a given stock symbol.",
)
def stock_details(
...
@router.get(
    ...
    responses={
        400: {"description": "Failed to retrieve historical data for the requested symbol/period"}
    },
)
def stock_history(
