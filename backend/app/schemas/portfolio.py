...
class PortfolioRow(BaseModel):
    ...
    account_number: str | None = Field(default=None, examples=["EE-1234567"])
    statement_end_date: date | None = Field(default=None, examples=["2026-07-31"])
    statement_start_date: date | None = Field(default=None, examples=["2026-07-01"])
    account_type: str | None = Field(
        default=None,
...
class ConcentrationFlag(BaseModel):
    ...
    name: str | None = Field(default=None, examples=["Sygnia Itrix S&P 500 ETF"])
