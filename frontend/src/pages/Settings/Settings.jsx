      ...
      >
        ...
        >
          <h2
            ...
            style={{ color: 'var(--signal-negative,#ef4444)' }}
          >
            Delete Account
          </h2>
        </div>
        <div className="px-5 py-4 flex flex-col gap-4">
          {!confirming ? (
            <>
              ...
              <ul
                className="text-[11px] leading-relaxed flex flex-col gap-1"
                style={{ color: 'var(--text-secondary,#a0a0a0)' }}
              >
            ...
            <>
              <p
                ...
                style={{ color: 'var(--text-secondary,#a0a0a0)' }}
              >
                Are you absolutely sure? This is your final confirmation for{' '}
                <span style={{ color: 'var(--text-primary,#e5e5e5)' }}>{userEmail}</span>.
              </p>
              {error && (
...
export default function Settings() {
  ...
  const emailMatches =
    typedEmail.trim().toLowerCase() === userEmail.trim().toLowerCase() && userEmail.length > 0;
  ...
  return (
    <div
      className="p-4 flex flex-col gap-4 max-w-[800px] mx-auto w-full"
    ...
    >
      ...
      <div className="glass-surface rounded-xl p-5">
        ...
        <label
          className="text-[9px] uppercase tracking-widest font-medium mb-2 block"
          style={{ color: 'var(--text-ghost,#444)' }}
        >
