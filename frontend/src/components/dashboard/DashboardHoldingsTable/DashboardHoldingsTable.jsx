  ...
  return (
    <div className="group relative">
      ...
      <GlassPanel className="flex flex-col">
        ...
        {holdings.length === 0 ? (
          <div
            className="flex flex-1 items-center justify-center p-8 text-center text-[12px]"
          ...
          <>
            <div className="flex flex-1 flex-col gap-5 p-5 lg:flex-row">
              ...
              >
                ...
                <div
                  className="mb-2.5 grid grid-cols-2 gap-2.5 pb-2.5"
                ...
                <div className="mb-1 flex w-full items-center gap-1">
                  <div className="flex flex-1 items-center justify-between px-2">
                    ...
                    <div
                      className="flex items-center gap-2.5 font-mono text-[9px] tracking-widest"
                      style={{ color: 'var(--text-ghost)' }}
                    >
                            ...
                            >
                              ...
                              <div className="flex items-center gap-2.5 text-right">
                                <span
                                  ...
                                  style={{
                                    color: getConcRisk(weight).color,
                                ...
                                <span
                                  className={`${COL.weight} font-mono text-[11px]`}
                                  style={{ color: 'var(--text-ghost)' }}
                                >
                                  {weight.toFixed(1)}%
                                </span>
                                <span
                                  className={`${COL.today} font-mono text-[11px]`}
                                  title={
                                    dailyKnown
                                      ? undefined
                                ...
                                <Money
                                  as="span"
                                  className={`${COL.value} font-mono text-[12px] font-semibold`}
                                >
                                  {zar(h.value ?? 0)}
                                </Money>
                              </div>
                          ...
                          <AnimatedReveal show={isExpanded}>
                            ...
                            >
                              ...
                              <HoldingDetailStat
                                ...
                                color={
                                  gainPositive ? 'var(--signal-positive)' : 'var(--signal-negative)'
                                }
                              />
                              <HoldingDetailStat
                                label="Held Since"
