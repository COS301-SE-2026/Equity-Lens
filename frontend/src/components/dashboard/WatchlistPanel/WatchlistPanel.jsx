    ...
    <>
      ...
      {adding && (
        <>
            ...
            <div className="relative min-w-0 flex-1">
              <input
                ...
                aria-activedescendant={
                  activeIndex >= 0 ? `watchlist-suggestion-${activeIndex}` : undefined
                }
              ...
              {showDropdown && (
                <div className="glass-surface-elevated absolute left-0 right-0 top-full z-10 mt-1 max-h-48 overflow-y-auto rounded-md py-1">
                  ...
                  {suggestStatus === 'done' && (
                    <ul
                      id="watchlist-suggestion-listbox"
                      role="listbox"
          ...
          {addError && (
            <p
              className="px-3 pt-1.5 font-mono text-[10px]"
              style={{ color: 'var(--signal-negative)' }}
            >
              {addError}
            </p>
