        ...
        <div className="flex-1 p-2">
          {top.map((h) => {
            ...
            return (
              <div
                key={h.ticker}
                className="flex items-center justify-between rounded-md px-3 py-2.5 transition-colors hover:bg-[var(--glass-hover)]"
              >
                <div className="min-w-0">
                  <div className="font-mono text-[12px] font-bold">{h.ticker}</div>
                  <div className="truncate text-[10px]" style={{ color: 'var(--text-ghost)' }}>
                    {h.name}
                  </div>
                </div>
